...
$pref::HUD::tempBrickOutsideRed = 1.0;
$pref::HUD::tempBrickOutsideGreen = 1.0;
$pref::HUD::tempBrickOutsideBlue = 1.0;
$pref::HUD::tempBrickInsideUsePaintColor = 0;
$pref::HUD::tempBrickInsideRed = 0.0;
$pref::HUD::tempBrickInsideGreen = 0.0;
$pref::HUD::tempBrickInsideBlue = 0.0;
...
function vendorSpecificDefaults ()
{
	...
	else
	{
		...
		{
			if ( strpos(%renderer, 8800) != -1  ||  strpos(%renderer, 8600) != -1  ||  
				 strpos(%renderer, 7900) != -1  ||  strpos(%renderer, 7800) != -1  ||
				 strpos(%renderer, 7600) != -1  ||  strpos(%renderer, 6800) != -1 )
			{
		...
		{
			if ( strpos(%renderer, "HD2900") != -1  ||  strpos(%renderer, "HD3870") != -1  || 
				 strpos(%renderer, 1950)     != -1  ||  strpos(%renderer, "X850")   != -1  ||
				 strpos(%renderer, "X1800")  != -1  ||  strpos(%renderer, "X1650")  != -1  || 
				 strpos(%renderer, "X1300")  != -1  ||  strpos(%renderer, "X1600")  != -1 )
			{
				$pref::OpenGL::anisotropy = 1.0;
				$pref::OpenGL::textureTrilinear = 1;
			}
...
// Do we really need this many defaults?!
